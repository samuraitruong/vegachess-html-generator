country_mapping = {
    ...
    'TCD': 'TD', 'CHL': 'CL', 'CHN': 'CN', 'CXR': 'CX', 'CCK': 'CC',
    ...
    'HMD': 'HM', 'VAT': 'VA', 'HND': 'HN', 'HKG': 'HK', 'HUN': 'HU',
    ...
    'LTU': 'LT', 'LUX': 'LU', 'MAC': 'MO', 'MKD': 'MK', 'MDG': 'MG',
    'MWI': 'MW', 'MYS': 'MY', 'MDV': 'MV', 'MLI': 'ML', 'MLT': 'MT',
    'MHL': 'MH', 'MTQ': 'MQ', 'MRT': 'MR', 'MUS': 'MU', 'MEX': 'MX',
    'FSM': 'FM', 'MDA': 'MD', 'MCO': 'MC', 'MNG': 'MN', 'MSR': 'MS',
    'MAR': 'MA', 'MOZ': 'MZ', 'MMR': 'MM', 'NAM': 'NA', 'NRU': 'NR',
    'NPL': 'NP', 'NLD': 'NL', 'ANT': 'AN', 'NCL': 'NC', 'NZL': 'NZ',
    ...
    'QAT': 'QA', 'REU': 'RE', 'ROM': 'RO', 'RUS': 'RU', 'RWA': 'RW',
    'SHN': 'SH', 'KNA': 'KN', 'LCA': 'LC', 'SPM': 'PM', 'VCT': 'VC',
    ...
    'VUT': 'VU', 'VEN': 'VE', 'VIE': 'VN', 'VGB': 'VG', 'VIR': 'VI',
    'WLF': 'WF', 'ESH': 'EH', 'YEM': 'YE', 'ZMB': 'ZM', 'ZWE': 'ZW'
}

def get_fed_icon(fed) :
    code = country_mapping.get(fed.upper())
    if code == None:
        code = 'au'
    return f'https://flagicons.lipis.dev/flags/4x3/{code.lower()}.svg'
